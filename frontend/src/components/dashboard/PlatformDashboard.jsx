...
const PlatformDashboard = () => {
    ...
    if (loading) return (
        <div className="min-h-[40vh] flex flex-col items-center justify-center p-8 text-center animate-pulse">
    ...
    return (
        <div className="space-y-8 md:space-y-12 animate-fade-in pb-24 max-w-[1600px] mx-auto px-4 md:px-8 pt-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
                <div className="bg-white p-8 md:p-10 rounded-[48px] border border-pharmacy-100 shadow-xl shadow-pharmacy-900/[0.02] flex flex-col">
